...
pub use self::encryptor::{Encryptor, SecretStoreEncryptor};
...
pub struct Provider<E: Encryptor = SecretStoreEncryptor> {
...
impl<E> Provider<E> where E: Encryptor {
...
mod test {
	...
	use private_transactions::encryptor::tests::DummyEncryptor;
	use super::Provider;
	...
	fn private_contract() {
		...
		let pm = Provider::new(DummyEncryptor::default());
