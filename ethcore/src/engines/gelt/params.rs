...
/// `Gelt` params.
pub struct GeltParams {
	/// List of validators.
	pub validators: Box<ValidatorSet>,
	/// Timeout durations for different steps.
	pub timeouts: GeltTimeouts,
...
impl Timeouts<Step> for GeltTimeouts {
...
impl From<ethjson::spec::GeltParams> for GeltParams {
	fn from(p: ethjson::spec::GeltParams) -> Self {
		let dt = GeltTimeouts::default();
		GeltParams {
			validators: new_validator_set(p.validators),
			timeouts: GeltTimeouts {
